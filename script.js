...
document.addEventListener('DOMContentLoaded', function() {
    // Создаем пиксельную волну

    const pixelWave = document.createElement('div');
    pixelWave.className = 'pixel-wave';
    document.querySelector('.hero').appendChild(pixelWave);
    // Пиксельный эффект для кнопки "Исследовать проекты"
...
ctaButton.addEventListener('mouseleave', function() {
    ...
    // Создаем пиксельный коннектор
    const pixelConnector = document.createElement('div');
    pixelConnector.className = 'pixel-connector';
    document.querySelector('.hero').appendChild(pixelConnector);
});
